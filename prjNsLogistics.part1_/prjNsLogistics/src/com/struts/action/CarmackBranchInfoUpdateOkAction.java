 ...
 * @struts.action
 */
public class CarmackBranchInfoUpdateOkAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		CarmackBranchInfoForm cbif = (CarmackBranchInfoForm) form;
		boolean bl=bs.getBranchinfobu().update(cbif);
		if(bl){
			return mapping.findForward("BranchInfoUpdateOk");
		}
		return null;
	}
}