 ...
 * @struts.action 
 */
public class CarmackTruckModelUpdateAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		CarmackTruckModelForm ef=(CarmackTruckModelForm) bs.getTruckmodelbu().findById(id);
		request.setAttribute("truckModel", ef);
		return mapping.findForward("TruckModelUpdate");
	}
}