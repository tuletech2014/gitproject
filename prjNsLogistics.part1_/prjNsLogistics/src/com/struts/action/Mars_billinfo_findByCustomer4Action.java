 ...
 * @struts.action
 */
public class Mars_billinfo_findByCustomer4Action extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Vector billvc=bs.getBillinfobusiness().findByCustomer(customerid, billstartdata, billenddata, billstateid,branchid);
