 ...
 * @struts.action
 */
public class Mars_billinfo_findByReceiveBranchshareAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Vector billvc=bs.getBillinfobusiness().findByReceiveBranchshare(branchid, billstateid);
