 ...
 * @struts.action
 */
public class CarmackDriverInfoListAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Vector driverInfovc=bs.getDriverinfobu().findByBranchID(new Integer(bi.getBranchid()));
		request.setAttribute("driverInfovc",driverInfovc);
		
		return mapping.findForward("dilist");
	}
}