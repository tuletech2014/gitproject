 ...
 * @struts.action
 */
public class CarmackBranchInfoListAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Vector branchInfovc=bs.getBranchinfobu().findAll();
		
		request.setAttribute("branchInfovc",branchInfovc);
		return mapping.findForward("bilist");
	}
