 ...
 * @struts.action
 */
public class CarmackUserInfoListAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Vector userInfovc=bs.getUserinfobu().findByBranchID(new Integer(bi.getBranchid()));
		request.setAttribute("userInfovc",userInfovc);
		
		return mapping.findForward("uilist");
	}
