 ...
 * @struts.action
 */
public class CarmackTruckInfoUpdateOkAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		CarmackTruckInfoForm ctif=(CarmackTruckInfoForm) form;
		boolean bl=bs.getTruckinfobu().update(ctif);
		if(bl)
		{
			return mapping.findForward("CarmacktruckInfoUpdateOk");
		}
		return null;
	}
}