 ...
 * @struts.action
 */
public class Mars_billinfo_findByBranchinf4Action extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Vector billvc=bs.getBillinfobusiness().findByBranchinf(branchid, billstartdata, billenddata, billstateid);
