 ...
 * @struts.action
 */
public class Mars_billinfo_findByReceiveBranch4Action extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Vector billvc=bs.getBillinfobusiness().findByReceiveBranch(branchid, billstartdata, billenddata, billstateid);
		request.getSession(true).setAttribute("billvc", billvc);
		return mapping.findForward("��Ʊ���list��");
	}
