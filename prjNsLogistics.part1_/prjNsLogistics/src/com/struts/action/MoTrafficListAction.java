 ...
 */
public class MoTrafficListAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Vector vctbi = new Vector();
		
		if (ui.getRoleid().equals("1000")) {
			vctbi=mobs.getMotralogbuss().findByStateID(new Integer(bisID), 0);
			
		}else{
			vctbi=mobs.getMotralogbuss().findByStateID(new Integer(bisID), new Integer(ui.getBranchid()));
		}
		
		request.setAttribute("movctbi",vctbi);
	
		return mapping.findForward("motralist");
	}
}