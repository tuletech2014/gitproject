 ...
 * @struts.action
 */
public class Mars_billinfo_findByReceiveBranch3Action extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Vector billvc=bs.getBillinfobusiness().findByReceiveBranch(branchid, billstartdata, billenddata);
